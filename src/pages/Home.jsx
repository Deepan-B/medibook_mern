...
const Home = () => {
  return (
    <>
      {/* =====hero section */}
      <>
        <section className="mt-[15px] mb-[70px]">
              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    ...
                    Quasi molestiae modi, reiciendis praesentium cupiditate
                    ducimus sunt necessitatibus in delectus ipsa ipsam natus
                    dicta eligendi rerum.
                  </p>
                ...
                <div className=" mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap lg:gap-[30px]">
                  <div>
          ...
          <div className="container">
            <div className="lg:w-[470px] mx-auto">
              ...
              <p className="text__para text-center">
                ...
                unaffected, expert health care.
              </p>
            </div>

            {/* <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]"> */}
            <div className="flex flex-wrap justify-center items-center gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
              <div className="py-[30px] px-5 sm:max-w-xs border-4 rounded-md shadow-2xl">
            ...
            <div className="flex items-center justify-between flex-col lg:flex-row">
              <div className="xl:w-[670px]">
                ...
                <ul className="pl-4">
                  ...
                  <li className="text__para">
                    2. Search for your physicians here, and contact their
                    office.
                  </li>
                  <li className="text__para">
                    3. View our physicians who are accepting new patients, use
                    the online scheduling tool to select tan appoinment time.
                  </li>
                </ul>
                <Link to="/">
              ...
              <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                ...
                <div className="w-[150px] lg:w-[200px] xl:w-[248px] bg-white absolute bottom-[50px] left-0 md:left-5 z-11 p-2 pb-3 lg:px-4 rounded-[10px]">
                  ...
                  <div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 rounded-full">
                    Consultation
                  </div>
